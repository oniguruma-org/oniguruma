...
/* Command-line: gperf -pt -T -L ANSI-C -N onigenc_sjis_lookup_property_name
 * --output-file gperf2.tmp sjis_prop.gperf  */
...
onigenc_sjis_lookup_property_name(register const char *str,
                                  register size_t len) {
