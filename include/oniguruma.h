...
/* options (compile time) */
#define ONIG_OPTION_IGNORECASE_IS_ASCII                                        \
...
#define ONIG_SYN_OP2_QMARK_CAPITAL_P_NAME                                      \
  (1U << 31) /* (?P<name>...) (?P=name) */
...
typedef int (*OnigCallbackEachMatchFunc)(const OnigUChar *str,
                                         const OnigUChar *end,
                                         const OnigUChar *match_start,
...
int onig_set_retry_limit_in_match_of_match_param P_((OnigMatchParam * param,
                                                     unsigned long limit));
ONIG_EXTERN
int onig_set_retry_limit_in_search_of_match_param P_((OnigMatchParam * param,
                                                      unsigned long limit));
ONIG_EXTERN
...
int onig_get_callout_data_by_tag_dont_clear_old
    P_((OnigRegex reg, OnigMatchParam *mp, const OnigUChar *tag,
        const OnigUChar *tag_end, int slot, OnigType *type, OnigValue *val));
