...
static void result(int no, int from, int to, int expected_from,
                   int expected_to) {
...
static int x(int no, char *pattern_arg, char *str_arg, int expected_from,
             int expected_to) {
  int r;
...
static int f(int no, char *pattern_arg, char *str_arg) {
