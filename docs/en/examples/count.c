...
static int test(OnigEncoding enc, OnigMatchParam *mp, char *in_pattern,
  ...
  r = onig_new(&reg, pattern, pattern + ulen(enc, pattern), ONIG_OPTION_DEFAULT,
               enc, ONIG_SYNTAX_DEFAULT, &einfo);
  if (r != ONIG_NORMAL) {
  ...
  show_count:
    ...
    slot = 0;
    r = onig_get_callout_data_by_tag_dont_clear_old(
        reg, mp, (UChar *)tag, (UChar *)tag + tag_len, slot, 0, &val);
    if (r < ONIG_NORMAL)
      goto err;
...
extern int main(int argc, char *argv[]) {
  ...
  test(encs[1], mp,
       "\000a\000b\000c\000(\000.\000(\000*\000C\000O\000U\000N\000T\000["
       "\000x\000]\000)\000)\000*\000(\000*\000F\000A\000I\000L\000)\000\000",
       "\000a\000b\000c\000d\000e\000f\000g\000\000");

  test(encs[2], mp,
       "a\000b\000c\000(\000.\000(\000*\000C\000O\000U\000N\000T\000[\000x\000]"
       "\000)\000)\000*\000(\000*\000F\000A\000I\000L\000)\000\000\000",
       "a\000b\000c\000d\000e\000f\000g\000\000\000");
